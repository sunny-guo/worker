...
public class ThreadLocalMetricsRecorder implements MetricsRecorder {
	...
	protected String requestInfor;
	protected String responseInfor;
	protected String status;
	
	public void setReq(String m){
		requestInfor = m;
	}
	...
	protected void init() {
		...
		waitingTimer = new NanoSecondTimer();
	}
	...
	public Metrics captureMetrics() {
		return new BasicMetrics(blockingTimer.getDuration(), dnsTimer
				...
				responseTransportCounter.get(),dnsTimer.getStart(),dnsTimer.getStop(),
				connectionTimer.getStart(),connectionTimer.getStop(),requestTimer.getStart(),
				requestTimer.getStop(),requestTimer.getStop(),responseTimer.getStart(),
				responseTimer.getStart(),responseTimer.getStop());
	}
}
