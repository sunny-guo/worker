...
public interface Metrics {
	...
	long getDnsStartTime();
	
	long getDnsEndTime();

	long getConnectingCost();
	
	long getConnectingStartTime();
	
	long getConnectingEndTime();

	long getSendingCost();
	
	long getSendingStartTime();
	
	long getSendingEndTime();

	long getWaitingCost();// sending --|-- waiting --|-- receiving
	
	long getWaitingStartTime();
	
	long getWaitingEndTime();

	long getReceivingCost();
	
	long getReceivingStartTime();
	
	long getReceivingEndTime();
